...
<h3 align="center">A passionate final-year CSE student at CVR COLLEGE OF ENGINEERING. Full-stack web developer, ML/AI enthusiast, and competitive programmer.</h3>

## 🚀 About Me

- 🌱 Currently learning **Deep Learning, Computer Vision & NLP** and **DSA in Java**
...
![CNN](https://img.shields.io/badge/CNN-4B8BBE?style=for-the-badge)
...
- 🎨 [ NeuroStyle ](https://github.com/komalsathvik) — Real-time arbitrary style transfer using a CNN (VGG-19) encoder-decoder with AdaIN, custom training pipeline (perceptual loss, Adam optimizer, LR scheduling), served through a Flask app with tunable style-strength control.
- 📝 [ TextAnalyzer ](https://github.com/komalsathvik) — AI-powered text summarization engine fine-tuning a HuggingFace T5 transformer for abstractive summarization, with a Flask REST API for real-time summaries evaluated using ROUGE metrics.
...
- 🏪 StorePilot — Retail solution built at CodeRift Hackathon (1st place, 30+ teams) featuring multilingual support and automated WhatsApp reminders.
...
- 🥇 **1st Place – CodeRift Hackathon**, Ciencia, CVR College of Engineering (2026) — secured 1st place among 30+ teams in an 8-hour competitive hackathon, building StorePilot.
- 🎖️ **Participant – Intel Hackathon** (2025) — competed in an online national-level hackathon, developed a full-stack product page with an AI chatbot for direct customer sales.

## 💼 Experience

- **GDGC-CVR Web Team Lead** (Oct 2024 – Present) — Leading the Web Team at GDG on Campus CVR, building and maintaining event platforms and club websites, including [code-nyx.tech](https://code-nyx.tech), a Next.js-based hackathon registration and information site.
- **Open Source Contributions** (2025) — Contributed during Hacktoberfest '25 and GSSoC '25, delivering feature enhancements and bug fixes, and improving project documentation across multiple repositories.

---

## 🧠 Data Structures & Algorithms

I actively solve problems on **LeetCode** (max rating 1804) and **CodeChef** to sharpen my algorithmic skills.
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=komalsathvik&show_icons=true&theme=tokyonight&hide_border=true)
